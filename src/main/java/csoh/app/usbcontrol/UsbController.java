...
public class UsbController implements Runnable {
	...
	public void setupUsb(short vendor_id, short product_id)
	...
	public int androidDeviceToAccessoryMode(String vendor, String model,
			String description, String version, String url, String serial)
			throws LibUsbException, GeneralException {
	...
	private int transferSetupPacket(DeviceHandle handle, byte requestType,
			byte request) throws LibUsbException {
		int response = 0;
	...
	private int readBulkData(DeviceHandle handle, byte endpoint,
			int dataLength, long timeout) {
