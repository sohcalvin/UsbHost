...
public class ConnectMessage extends Message {
     ...
     */
    public ConnectMessage(int version, int maxData, String systemType, String serialNo, String banner) {
	...
	return String.format("CONNECT(0x%08x, %d, \"%s\")", getVersion(),
		getMaxData(), getIdentity());
    }
}
